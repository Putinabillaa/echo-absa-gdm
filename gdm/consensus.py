...
def main():
    ...
    parser.add_argument("-p", "--p-inner", type=float, default=1, help="Power parameter for inner consensus calculation")
    ...
    for comm, members in filtered.items():
        ...
        cc, _ = calculate_consensus(comm_pairs, members, p_inner=args.p_inner)
        if cc is not None:
